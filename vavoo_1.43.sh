...
echo -e "${CYAN}"
echo "################################################################"
echo "#         Start downloading and installing  vavoo_1.43         #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/1912/refs/heads/main/enigma2-plugin-extensions-vavoo_1.43_all.ipk"
IPK_NAME="enigma2-plugin-extensions-vavoo_1.43_all.ipk"
